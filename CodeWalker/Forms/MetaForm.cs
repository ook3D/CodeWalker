...
public partial class MetaForm : Form
{
    ...
    public void LoadMeta(YndFile ynd)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (ynd?.RpfFileEntry != null) metaFormat = MetaFormat.Ynd;
    }
    ...
    public void LoadMeta(YldFile yld)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (yld?.RpfFileEntry != null) metaFormat = MetaFormat.Yld;
    }
    ...
    public void LoadMeta(YedFile yed)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (yed?.RpfFileEntry != null) metaFormat = MetaFormat.Yed;
    }
    ...
    public void LoadMeta(CacheDatFile cachedat)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (cachedat?.FileEntry != null) metaFormat = MetaFormat.CacheFile;
    }
    ...
    public void LoadMeta(HeightmapFile heightmap)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (heightmap?.RpfFileEntry != null) metaFormat = MetaFormat.Heightmap;
    }
    ...
    public void LoadMeta(YpdbFile ypdb)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (ypdb?.RpfFileEntry != null) metaFormat = MetaFormat.Ypdb;
    }
    ...
    public void LoadMeta(YfdFile yfd)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (yfd?.RpfFileEntry != null) metaFormat = MetaFormat.Yfd;
    }
    ...
    public void LoadMeta(MrfFile mrf)
    {
        ...
        modified = false;
        metaFormat = MetaFormat.XML;
        if (mrf?.RpfFileEntry != null) metaFormat = MetaFormat.Mrf;
    }
