...
public partial class VehicleForm : Form, DXForm
{
    ...
    private bool PlayConvRoofAnim;

    public Renderer Renderer;
    private volatile bool running;


    private readonly Vehicle SelectedVehicle = new();
    ...
    private void UpdateGlobalVehiclesUI()
    {
        ...
        else
        {
            ...
            foreach (var vehicle in vehicles) VehicleModelComboBox.Items.Add(vehicle.modelName);

            if (vehicles.Count > 0) VehicleModelComboBox.SelectedIndex = 0;
        }
    }
    ...
    public void LoadVehicle()
    {
        ...
        var hidet = VehicleHighDetailCheckBox.Checked;
        var vehiclechange = SelectedVehicle.Name != name;
    ...
    public void LoadModel(YftFile yft, bool movecamera = true)
    {
        ...
        if (movecamera && dr != null) MoveCameraToView(dr.BoundingCenter, dr.BoundingSphereRadius);
    ...
    private void RenderVehicle()
    {
        ...
        if (PlayConvRoofAnim) clip = SelectedVehicle.ConvRoofClip;
