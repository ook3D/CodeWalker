...
public partial class EditAudioAmbientRulePanel : ProjectPanel
{
    ...
    private void UpdateUI()
    {
        ...
        {
            AddToProjectButton.Enabled = CurrentRule?.RelFile != null
                ? !ProjectForm.AudioFileExistsInProject(CurrentRule.RelFile)
                : false;
            ...
            if (ProjectForm.WorldForm != null) ProjectForm.WorldForm.SelectObject(CurrentRule);
        }
    }
    ...
    private void ProjectItemChanged()
    {
        ...
        if (CurrentRule?.RelFile != null) ProjectForm.SetAudioFileHasChanged(true);
    }
    ...
    private void WeightTextBox_TextChanged(object sender, EventArgs e)
    {
        ...
        var unk = FloatUtil.Parse(WeightTextBox.Text);
    ...
    private void StartTimeUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (ushort)StartTimeUpDown.Value;
    ...
    private void EndTimeUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (ushort)EndTimeUpDown.Value;
    ...
    private void MinRepeatUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (ushort)MinRepeatUpDown.Value;
    ...
    private void MinRepeatVarUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (ushort)MinRepeatVarUpDown.Value;
    ...
    private void SpawnHeightUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)SpawnHeightUpDown.Value;
    ...
    private void MaxLocalInstsUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)MaxLocalInstsUpDown.Value;
    ...
    private void MaxGlobalInstsUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)MaxGlobalInstsUpDown.Value;
    ...
    private void BlockabilityUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)BlockabilityUpDown.Value;
    ...
    private void MaxPathDepthUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)MaxPathDepthUpDown.Value;
    ...
    private void GoToButton_Click(object sender, EventArgs e)
    {
        ...
        ProjectForm.WorldForm.GoToPosition(CurrentRule.Position, Vector3.One * CurrentRule.OuterRadius);
    }
