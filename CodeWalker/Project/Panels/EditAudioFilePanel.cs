...
public partial class EditAudioFilePanel : ProjectPanel
{
    ...
    private void UpdateUI()
    {
        ...
        else
        {
            ...
            ProjectPathTextBox.Text =
                project != null ? project.GetRelativePath(CurrentFile.FilePath) : CurrentFile.FilePath;
            populatingui = false;
        }
    }
    ...
    {
        if (CurrentFile != null) ProjectForm.SetAudioFileHasChanged(true);
    }
    ...
    private void UnkVersionUpDown_ValueChanged(object sender, EventArgs e)
    {
        ...
        var unk = (byte)UnkVersionUpDown.Value;
