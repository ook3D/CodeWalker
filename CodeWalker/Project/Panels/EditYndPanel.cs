...
public partial class EditYndPanel : ProjectPanel
{
    ...
    {
        var fn = Ynd.RpfFileEntry?.Name ?? Ynd.Name;
    ...
    public void UpdateYndUI()
    {
        ...
        else
        {
            ...
            YndProjectPathTextBox.Text =
                Ynd != null ? ProjectForm.CurrentProjectFile.GetRelativePath(Ynd.FilePath) : Ynd.FilePath;
            YndAreaIDXUpDown.Value = Ynd.CellX;
            YndAreaIDYUpDown.Value = Ynd.CellY;
            YndAreaIDInfoLabel.Text = "ID: " + Ynd.AreaID;
    ...
    private void YndAreaIDUpDownChange()
    {
        ...
        if (Ynd == null) return;
        var x = (int)YndAreaIDXUpDown.Value;
        var y = (int)YndAreaIDYUpDown.Value;
        lock (ProjectForm.ProjectSyncRoot)
        {
            if (ProjectForm.WorldForm == null)
            {
                MessageBox.Show("You can only do this while the Project Window is open.", "Error", MessageBoxButtons.OK,
