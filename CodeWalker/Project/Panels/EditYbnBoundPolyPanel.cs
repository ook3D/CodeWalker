...
public partial class EditYbnBoundPolyPanel : ProjectPanel
{
    ...
    private void LoadDropDowns()
    {
        ...
        foreach (var mat in BoundsMaterialTypes.Materials) MatTypeCombo.Items.Add(mat);
    }
    ...
    {
        var changed = CollisionPoly?.Owner?.HasChanged ?? false;
    ...
    {
        var fn = CollisionPoly?.Title ?? "untitled";
