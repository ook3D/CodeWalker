...
public partial class EditAudioInteriorRoomPanel : ProjectPanel
{
    ...
    private void UpdateUI()
    {
        ...
        else
        {
            ...
            DeleteButton.Enabled =
                !(CurrentRoom?.Rel != null
                    ? !ProjectForm.AudioFileExistsInProject(CurrentRoom.Rel)
                    : false); // AddToProjectButton.Enabled;
    ...
    {
        if (CurrentRoom?.Rel != null) ProjectForm.SetAudioFileHasChanged(true);
    }
