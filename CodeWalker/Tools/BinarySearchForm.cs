...
public partial class BinarySearchForm : Form
{
    ...
    private GameFileCache FileCache;
    private volatile bool InProgress;
    private RpfManager RpfMan;


    private readonly List<RpfSearchResult> RpfSearchResults = new();
    private RpfEntry RpfSelectedEntry;
    private int RpfSelectedLength;
    ...
    private void FileSearchFolderBrowseButton_Click(object sender, EventArgs e)
    {
        ...
        if (res == DialogResult.OK) FileSearchFolderTextBox.Text = FolderBrowserDialog.SelectedPath;
    }

    private void FileSearchButton_Click(object sender, EventArgs e)
    {
        var searchtxt = FileSearchTextBox.Text;
        var searchfolder = FileSearchFolderTextBox.Text;
        ...
        Task.Run(() =>
        {
            ...
            var filenames = Directory.GetFiles(searchfolder);
    ...
    private void RpfSearch()
    {
        ...
        var searchtxt = RpfSearchTextBox.Text;
        var hex = RpfSearchHexRadioButton.Checked;
        var casesen = RpfSearchCaseSensitiveCheckBox.Checked || hex;
        var bothdirs = RpfSearchBothDirectionsCheckBox.Checked;
        ...
        if (RpfSearchOnlyCheckBox.Checked)
        {
            ...
            for (var i = 0; i < onlyexts.Length; i++) onlyexts[i] = onlyexts[i].Trim();
        }
        ...
        Task.Run(() =>
        {
            ...
            for (var f = 0; f < scannedFiles.Count; f++)
            {
                ...
                foreach (var entry in rpffile.AllEntries)
                {
                    ...
                    {
                        var ignore = true;
                        for (var i = 0; i < onlyexts.Length; i++)
    ...
    {
        RpfSearchIgnoreTextBox.Enabled = RpfSearchIgnoreCheckBox.Checked;
        if (RpfSearchIgnoreCheckBox.Checked) RpfSearchOnlyCheckBox.Checked = false;
    }
    ...
    private void RpfSearchOnlyCheckBox_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (RpfSearchOnlyCheckBox.Checked) RpfSearchIgnoreCheckBox.Checked = false;
    }
    ...
    private void RpfSearchResultsListView_RetrieveVirtualItem(object sender, RetrieveVirtualItemEventArgs e)
    {
        ...
        {
            var r = RpfSearchResults[e.ItemIndex];
    ...
    private void ExportButton_Click(object sender, EventArgs e)
    {
        ...
        var rfe = RpfSelectedEntry as RpfFileEntry;
        if (rfe == null)
        {
