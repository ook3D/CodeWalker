...
{
    private readonly Dictionary<uint, string> extraStrings = new();
        ...
        else
        {
            ...
            if (gameFileCache == null || gameFileCache.IsInited == false)
                Task.Run(() =>
                {
                    ...
                    var gfc = GameFileCacheFactory.Create();
    ...
    private void FindHash()
    {
        ...
        var hasstr = !string.IsNullOrEmpty(str);
        var hastxt = !string.IsNullOrEmpty(txt);
        var hasext = !string.IsNullOrEmpty(ext);
        var hassta = !string.IsNullOrEmpty(sta);
    ...
    private void LoadStringsButton_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MessageBox.Show(lines.Length + " strings imported successfully.");
        }
        catch
        {
    ...
    private void SaveStringsButton_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MessageBox.Show(lines.Length + " strings exported successfully.");
        }
        catch
        {
