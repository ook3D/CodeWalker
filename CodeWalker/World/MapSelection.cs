...
public struct MapSelection
{
    ...
    public BoundVertex[]
        GatheredCollisionVerts
    {
        get;
        private set;
    } //for collision polys, need to move all the individual vertices instead
    ...
    public bool HasHit => HitDist != float.MaxValue;
    ...
    public string GetNameString(string defval)
    {
        ...
        if (MultipleSelectionItems != null)
            ...
            name = enamec + "Vertex " + CollisionVertex.Index +
                   (CollisionBounds != null ? ": " + CollisionBounds.GetName() : string.Empty);
        else if (CollisionPoly != null)
            name = enamec + "Poly " + CollisionPoly.Index +
                   (CollisionBounds != null ? ": " + CollisionBounds.GetName() : string.Empty);
            ...
            name = (LodLight.Ymap?.Name ?? "") + ": " + LodLight.Index;
        else if (BoxOccluder != null)
            name = "BoxOccluder " + (BoxOccluder.Ymap?.Name ?? "") + ": " + BoxOccluder.Index;
        else if (OccludeModelTri != null)
            name = "OccludeModel " + (OccludeModelTri.Ymap?.Name ?? "") + ": " + (OccludeModelTri.Model?.Index ?? 0) +
                   ":" + OccludeModelTri.Index;
            ...
            name = "PathNode " + PathNode.AreaID + "." +
                   PathNode.NodeID; //+ FloatUtil.GetVector3String(PathNode.Position);
        ...
        if (MloRoomDef != null) name = "MloRoomDef " + MloRoomDef.RoomName;
        if (EntityExtension != null) name += ": " + EntityExtension.Name;
        if (ArchetypeExtension != null) name += ": " + ArchetypeExtension.Name;
        return name;
    }

    public string GetFullNameString(string defval)
    {
        var name = GetNameString(defval);
        if (Geometry != null) name += " (" + GeometryIndex + ")";
        return name;
    }
    ...
    public UndoStep CreateUndoStep(WidgetMode mode, Vector3 startPos, Quaternion startRot, Vector3 startScale,
        WorldForm wf, bool editPivot)
    {
        if (MultipleSelectionItems != null)
        {
            switch (mode)
        ...
        else if (CollisionVertex != null)
        {
            switch (mode)
            {
                case WidgetMode.Position:
                    return new CollisionVertexPositionUndoStep(CollisionVertex, EntityDef, startPos, wf);
            }
        }
        else if (CollisionPoly != null)
        {
            ...
            {
                case WidgetMode.Position:
                    return new CollisionPolyPositionUndoStep(CollisionPoly, EntityDef, startPos, wf);
                case WidgetMode.Rotation:
                    return new CollisionPolyRotationUndoStep(CollisionPoly, EntityDef, startRot, wf);
        ...
        else if (CollisionBounds != null)
        {
            ...
            {
                case WidgetMode.Position:
                    return new CollisionPositionUndoStep(CollisionBounds, EntityDef, startPos, wf);
                case WidgetMode.Rotation:
                    return new CollisionRotationUndoStep(CollisionBounds, EntityDef, startRot, wf);
    ...
    public Vector3 WidgetPosition
    {
        get
        {
            if (MultipleSelectionItems != null) return MultipleSelectionCenter;
            ...
            {
                if (EntityDef != null)
                    return EntityDef.Position + EntityDef.Orientation.Multiply(CollisionPoly.Position);
            ...
            {
                if (EntityDef != null)
                    return EntityDef.Position + EntityDef.Orientation.Multiply(CollisionBounds.Position);
            ...
            if (Audio != null) return Audio.InnerPos;
            return Vector3.Zero;
        }
    }
    ...
    public Quaternion WidgetRotation
    {
        get
        {
            if (MultipleSelectionItems != null) return MultipleSelectionRotation;
            ...
            if (Audio != null) return Audio.Orientation;
            return Quaternion.Identity;
        }
    }
    ...
    public WidgetAxis WidgetRotationAxes
    {
        get
        {
            ...
            if (ScenarioNode != null)
                return WidgetAxis.Z;
            if (Audio != null) return WidgetAxis.Z;
            return WidgetAxis.None;
        }
    }
    ...
    public Vector3 WidgetScale
    {
        get
        {
            ...
            if (ScenarioNode != null)
                return Vector3.One;
            if (Audio != null) return Vector3.One;
            return Vector3.One;
        }
    }
    ...
    public bool WidgetScaleLockXY
    {
        get
        {
            if (MultipleSelectionItems != null)
            {
                for (var i = 0; i < MultipleSelectionItems.Length; i++)
                    if (MultipleSelectionItems[i].EntityDef != null &&
                        MultipleSelectionItems[i].CollisionBounds == null)
                        return true;
                return false;
            }
    ...
    public bool CanCopyPaste
    {
        get
        {
            ...
            if (CollisionVertex != null)
                return false; //can't copy just a vertex..
            if (CollisionPoly != null)
                return true;
            if (CollisionBounds != null)
                return true;
            ...
            if (Audio?.AmbientRule != null)
                return true;
            if (Audio?.StaticEmitter != null) return true;
    ...
    public void SetMultipleSelectionItems(MapSelection[] items)
    {
        ...
        if (items != null)
        {
            ...
            if (collVerts != null) GatheredCollisionVerts = collVerts.Keys.ToArray();
            if (items.Length > 0) center *= 1.0f / items.Length;
        }
    ...
    public void SetPosition(Vector3 newpos, bool editPivot)
    {
        if (MultipleSelectionItems != null)
        {
            ...
            else
            {
                ...
                YmapEntityDef
                    ent = null; //hack to use an entity for multple selections... buggy if entities mismatch!!!
                for (var i = 0; i < MultipleSelectionItems.Length; i++)
                {
                ...
                if (GatheredCollisionVerts != null)
                    for (var i = 0; i < GatheredCollisionVerts.Length; i++)
                    {
        ...
        {
            if (EntityDef != null)
                newpos = Quaternion.Invert(EntityDef.Orientation).Multiply(newpos - EntityDef.Position);
        ...
        else if (PathNode != null)
        {
            ...
            foreach (var affectedFile in affectedFiles) WorldForm.UpdatePathYndGraphics(affectedFile, false);
        }
        else if (NavPoly != null)
        {
    ...
    public void UpdateGraphics(WorldForm wf)
    {
        if (MultipleSelectionItems != null)
        {
            ...
            {
                if (item.PathNode != null) pathYnds[item.PathNode.Ynd] = 1;
                if (item.NavPoly != null) navYnvs[item.NavPoly.Ynv] = 1;
                if (item.NavPoint != null) navYnvs[item.NavPoint.Ynv] = 1;
                if (item.NavPortal != null) navYnvs[item.NavPortal.Ynv] = 1;
                if (item.TrainTrackNode != null) trainTracks[item.TrainTrackNode.Track] = 1;
                if (item.ScenarioNode != null) scenarioYmts[item.ScenarioNode.Ymt] = 1;
                if (item.CollisionBounds != null) bounds[item.CollisionBounds] = 1;
                if (item.CollisionPoly?.Owner != null) bounds[item.CollisionPoly.Owner] = 1;
                if (item.CollisionVertex?.Owner != null) bounds[item.CollisionVertex.Owner] = 1;
                if (item.LodLight?.LodLights != null) lodlights[item.LodLight.LodLights] = 1;
                if (item.BoxOccluder != null) boxoccls[item.BoxOccluder] = 1;
                if (item.OccludeModelTri?.Model != null) occlmods[item.OccludeModelTri.Model] = 1;
            }

            foreach (var kvp in bounds) wf.UpdateCollisionBoundsGraphics(kvp.Key);
            foreach (var kvp in pathYnds) wf.UpdatePathYndGraphics(kvp.Key, false);
            foreach (var kvp in navYnvs) wf.UpdateNavYnvGraphics(kvp.Key, true);
            foreach (var kvp in trainTracks) wf.UpdateTrainTrackGraphics(kvp.Key, false);
            foreach (var kvp in scenarioYmts) wf.UpdateScenarioGraphics(kvp.Key, false);
            ...
            foreach (var kvp in boxoccls) wf.UpdateBoxOccluderGraphics(kvp.Key);
            foreach (var kvp in occlmods) wf.UpdateOccludeModelGraphics(kvp.Key);
        }
        else
        {
            if (PathNode != null) wf.UpdatePathYndGraphics(PathNode.Ynd, false);
            if (NavPoly != null) wf.UpdateNavYnvGraphics(NavPoly.Ynv, true);
            if (NavPoint != null) wf.UpdateNavYnvGraphics(NavPoint.Ynv, true);
            if (NavPortal != null) wf.UpdateNavYnvGraphics(NavPortal.Ynv, true);
            if (TrainTrackNode != null) wf.UpdateTrainTrackGraphics(TrainTrackNode.Track, false);
            if (ScenarioNode != null) wf.UpdateScenarioGraphics(ScenarioNode.Ymt, false);
            ...
            else if (OccludeModelTri?.Model != null) wf.UpdateOccludeModelGraphics(OccludeModelTri?.Model);
        }
    }
    ...
    public object GetProjectObject()
    {
        ...
        if (Audio?.AmbientZone != null) return Audio;
        if (Audio?.AmbientRule != null) return Audio;
        if (Audio?.StaticEmitter != null) return Audio;
        return null;
    }
    ...
    public static MapSelection FromProjectObject(WorldForm worldForm, object o, object parent = null)
    {
        ...
        if (o is object[] arr)
        {
            ...
            for (var i = 0; i < arr.Length; i++) multi[i] = FromProjectObject(worldForm, arr[i]);
        ...
        else if (o is YmapEntityDef entity)
        {
            ...
            if (entity.MloInstance != null) ms.MloEntityDef = entity;
        }
