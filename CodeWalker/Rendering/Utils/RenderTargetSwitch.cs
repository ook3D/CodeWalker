...
public class RenderTargetSwitch
{
    ...
    private DepthStencilView OrigDepthStencilView;
    private RasterizerState OrigRasterizerState;

    private RenderTargetView[] OrigRenderTargetViewArr;

    private RawViewportF[] OrigViewports;

    //bool ResetOnDestroy = false;
    private readonly int RenderTargetCount = 1;
