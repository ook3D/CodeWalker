...
public class TerrainShader : Shader, IDisposable
{
    ...
    private readonly VertexShader pncctttxvs;
    private readonly VertexShader pnccttvs;
    private readonly VertexShader pnccttxvs;

    private readonly VertexShader pncctvs;
    private readonly VertexShader pncctxvs;
    private readonly VertexShader pnctttxvs;
    private readonly VertexShader pncttxvs;
    private readonly GpuVarsBuffer<TerrainShaderPSGeomVars> PSGeomVars;
    private readonly GpuVarsBuffer<TerrainShaderPSSceneVars> PSSceneVars;
    ...
    private readonly PixelShader terrainps;
    private readonly PixelShader terrainpsdef;
    private SamplerState texsampler;
    private SamplerState texsampleranis;
    private SamplerState texsamplertnt;
    private readonly GpuVarsBuffer<TerrainShaderVSEntityVars> VSEntityVars;
    private readonly GpuVarsBuffer<TerrainShaderVSGeomVars> VSGeomVars;
    private readonly GpuVarsBuffer<TerrainShaderVSModelVars> VSModelVars;
    private readonly GpuVarsBuffer<TerrainShaderVSSceneVars> VSSceneVars;


    public TerrainShader(Device device)
    {
        var vspncct = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCCT.cso");
        var vspncctt = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCCTT.cso");
        var vspnccttx = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCCTTX.cso");
        var vspncctttx = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCCTTTX.cso");
        var vspncctx = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCCTX.cso");
        var vspnctttx = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCTTTX.cso");
        var vspncttx = PathUtil.ReadAllBytes("Shaders\\TerrainVS_PNCTTX.cso");
        var psbytes = PathUtil.ReadAllBytes("Shaders\\TerrainPS.cso");
        var psdefbytes = PathUtil.ReadAllBytes("Shaders\\TerrainPS_Deferred.cso");
        ...
        layouts.Add(VertexType.PNCTTTX_3,
            new InputLayout(device, vspnctttx, VertexTypeGTAV.GetLayout(VertexType.PNCTTTX_3)));
        ...
        layouts.Add(VertexType.PNCCTTX,
            new InputLayout(device, vspnccttx, VertexTypeGTAV.GetLayout(VertexType.PNCCTTX)));
        layouts.Add(VertexType.PNCCTTX_2,
            new InputLayout(device, vspnccttx, VertexTypeGTAV.GetLayout(VertexType.PNCCTTX_2)));
        layouts.Add(VertexType.PNCCTTTX,
            new InputLayout(device, vspncctttx, VertexTypeGTAV.GetLayout(VertexType.PNCCTTTX)));
    ...
    private void SetVertexShader(DeviceContext context, uint shaderhash)
    {
        ...
        switch (shaderhash)
        {
            ...
            case 3400824277: //terrain_cb_w_4lyr_pxm_spm (terrain_cb_w_4lyr_pxm_spm.sps)  vt: PNCCTTX_2
                ...
                break;
            case 653544224
                : //terrain_cb_w_4lyr_2tex_blend_pxm_spm (terrain_cb_w_4lyr_2tex_blend_pxm_spm.sps)  vt: PNCCTTTX
    ...
    public override void SetGeomVars(DeviceContext context, RenderableGeometry geom)
    {
        ...
        var usediff0 = texture0 != null && texture0.ShaderResourceView != null;
        var usediff1 = texture1 != null && texture1.ShaderResourceView != null;
        var usediff2 = texture2 != null && texture2.ShaderResourceView != null;
        var usediff3 = texture3 != null && texture3.ShaderResourceView != null;
        var usediff4 = texture4 != null && texture4.ShaderResourceView != null;
        var usemask = texturemask != null && texturemask.ShaderResourceView != null;
        var usetint = tintpal != null && tintpal.ShaderResourceView != null;
        var usenm = (normals0 != null && normals0.ShaderResourceView != null) ||
                    (normals1 != null && normals1.ShaderResourceView != null);


        var bumpiness = 1.0f;
        if (usenm) bumpiness = geom.bumpiness;
