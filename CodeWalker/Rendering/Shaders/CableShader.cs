...
public class CableShader : Shader, IDisposable
{
    ...
    private readonly GpuVarsBuffer<CableShaderPSGeomVars> PSGeomVars;
    private readonly GpuVarsBuffer<CableShaderPSSceneVars> PSSceneVars;
    ...
    private readonly GpuVarsBuffer<CableShaderVSEntityVars> VSEntityVars;
    private readonly GpuVarsBuffer<CableShaderVSGeomVars> VSGeomVars;
    private readonly GpuVarsBuffer<CableShaderVSModelVars> VSModelVars;
    private readonly GpuVarsBuffer<CableShaderVSSceneVars> VSSceneVars;

    public CableShader(Device device)
    {
        var vsbytes = PathUtil.ReadAllBytes("Shaders\\CableVS.cso");
        var psbytes = PathUtil.ReadAllBytes("Shaders\\CablePS.cso");
        var psdefbytes = PathUtil.ReadAllBytes("Shaders\\CablePS_Deferred.cso");
