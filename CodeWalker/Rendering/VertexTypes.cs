...
public static class VertexTypeGTAV
{
    ...
    public static InputElement[] GetLayout(VertexType componentsFlags,
        VertexDeclarationTypes componentsTypes = VertexDeclarationTypes.GTAV1)
    {
        ...
        for (var k = 0; k < 16; k++)
            if (((flags >> k) & 0x1) == 1)
            {
                ...
                var index = inputElements.Where(e => e.SemanticName.Equals(Semantics[k])).Count();
...
public struct
    VertexTypePNCTTTTX //id: 1510590726, stride: 76, flags: 19673, refs: 3   //beach graffiti trees -  normal_spec_detail_dpm_vertdecal_tnt.sps
{
    public Vector3 Position;
    public Vector3 Normal;
    public uint Colour;
...
public struct
    VertexTypePCCH2H4 //id: 34185222, stride: 32, flags: 16473, types: 216172782140628998, refs: 2191 (yft only)  - frag cloth normalmapped
{
    public Vector3 Position;
...
public struct
    VertexTypePNCH2 //id: 17391622, stride: 32, flags: 89, types: 216172782140612614, refs: 1174 (yft only) - frag cloth default
{
    public Vector3 Position;
    public Vector3 Normal;
    public uint Colour;
